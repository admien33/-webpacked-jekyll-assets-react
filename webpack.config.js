...
path_tmp = config_yml.webpack_assets.components.path_input || './assets/js/app/components/';
const path_ref_components = path.resolve(__dirname,config_source,path_tmp);
...
//asset components, used on js
fse.copySync(path_ref_components, path.resolve(assets_wp_base, './components') )
